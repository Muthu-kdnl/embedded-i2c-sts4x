# Sensirion Embedded I2C STS4x Driver

This is a generic embedded driver for the [Sensirion STS4x Sensor](https://www.sensirion.com/).
It enables developers to communicate with the STS4x sensor on different hardware platforms by only adapting the I2C communication related source files.

<center><img src="images/STS4x.png" width="500px"></center>
...
4. Run the compiled executable with `./sts4x_i2c_example_usage`
